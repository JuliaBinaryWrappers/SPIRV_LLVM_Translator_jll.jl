# `SPIRV_LLVM_Translator_jll.jl` (v13.0.0+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c3fdd9d985d6ccbce5a529ab306230584707d79b/S/SPIRV_LLVM_Translator/SPIRV_LLVM_Translator@13/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/KhronosGroup/SPIRV-LLVM-Translator.git (revision: `093cf279cad6f12bb22abf0a94eae9aca938aaea`)
