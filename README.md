# `SPIRV_LLVM_Translator_jll.jl` (v15.0.0+1)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/f7086294a418d81d03c46e91f4d17441fc825a26/S/SPIRV_LLVM_Translator/SPIRV_LLVM_Translator@15/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/KhronosGroup/SPIRV-LLVM-Translator.git (revision: `1e170e22f65d6bf01e6c592f8ed845dcceb69bea`)
