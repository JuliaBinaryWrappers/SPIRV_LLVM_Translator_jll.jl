# `SPIRV_LLVM_Translator_jll.jl` (v16.0.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c3fdd9d985d6ccbce5a529ab306230584707d79b/S/SPIRV_LLVM_Translator/SPIRV_LLVM_Translator@16/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/KhronosGroup/SPIRV-LLVM-Translator.git (revision: `0b107dbf421593ed6f201ea2b7976e9456bc6bd3`)
