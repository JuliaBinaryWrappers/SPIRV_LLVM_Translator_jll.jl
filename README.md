# `SPIRV_LLVM_Translator_jll.jl` (v20.1.0+4)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/818fccc546de66bf7a6c620ac02409a25678c4da/S/SPIRV_LLVM_Translator/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* files in directory, relative to originating `build_tarballs.jl`: [`bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/818fccc546de66bf7a6c620ac02409a25678c4da/S/SPIRV_LLVM_Translator/bundled)
