# `SPIRV_LLVM_Translator_jll.jl` (v19.0.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c0cfe262b908b5fad8a4bc7a1631a25f651f1685/S/SPIRV_LLVM_Translator/SPIRV_LLVM_Translator@19/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
