# `SPIRV_LLVM_Translator_jll.jl` (v17.0.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c3fdd9d985d6ccbce5a529ab306230584707d79b/S/SPIRV_LLVM_Translator/SPIRV_LLVM_Translator@17/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
