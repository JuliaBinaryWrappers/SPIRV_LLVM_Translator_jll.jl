module SPIRV_LLVM_Translator_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SPIRV_LLVM_Translator_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("4a5d46fc-d8cf-5151-a261-86b458210efb"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SPIRV_LLVM_Translator", artifacts_toml) for e in artifacts["SPIRV_LLVM_Translator"]]
...
if best_platform === nothing
    @debug("Unable to load SPIRV_LLVM_Translator; unsupported platform $(triplet(platform_key_abi()))")
else
